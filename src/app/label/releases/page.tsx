...
export default function ReleasesPage() {
  return (
    <SimplePage
      ...
      description={{
        de: "Hier versammeln sich Tracks, EPs, Pressungen, Videos und die Kontexte, in denen sie im Umfeld der Base hörbar und sichtbar werden.",
        en: "Tracks, EPs, pressings, videos, and the contexts in which they become audible and visible around The Base gather here.",
      }}
      note={{
        de: "Im Profil erscheint diese Arbeit nie isoliert, sondern verbunden mit Premieren, Aufführungen und audiovisuellen Spuren.",
